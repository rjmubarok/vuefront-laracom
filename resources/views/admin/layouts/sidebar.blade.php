<aside class="navbar-aside" id="offcanvas_aside">
    <div class="aside-top">
        <a href="index.html" class="brand-wrap">
            <img src="{{ asset('assets/imgs/theme/logo.svg') }}" class="logo" alt="Evara Dashboard">
        </a>
        <div>
    ...
    <nav>
        <ul class="menu-aside">
            ...
            <li
                class="menu-item has-submenu @if(request()->routeIs('admin.category') OR request()->is('admin/product')) active @endif">
                <a class="menu-link" href="page-products-list.html"> <i class="icon material-icons md-shopping_bag"></i>
                    <span class="text">Products</span>
                </a>
                <div class="submenu">
                    <a href="{{route('admin.product')}}"
                        class="<?= request()->routeIs('admin.product') ? 'active' : "" ?>">Product List</a>
                    <a href="page-products-grid.html">Add Product</a>
                    <a href="{{route('admin.category')}}"
                        class="<?= request()->routeIs('admin.category') ? 'active' : "" ?>">Categories</a>
                </div>
            </li>
